   ...
   <div class="container">
    ...
    <div class="row pb-3">
        ...
        <div class="col-md-4 offset-2 float-rigth text-right">
            <a class="btn btn-primary text-capitalize" href="/usergroups/create"><i class="fa fa-plus"></i>Add user</a>
         </div>
        </div>
   </div>
    <div class="container">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    @foreach ($usergroupdata as $singleusergroup)
                                        <tr class="text-center">
                                            <td>{{$singleusergroup->id}}</td>
                                            <td>{{$singleusergroup->title}}</td>
                                            <td>
                                                <form action="usergroups/{{$singleusergroup->id}}" method="post">
                                                    @csrf
                                                    @method("delete")
